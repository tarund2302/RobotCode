...
public interface LEDRiverDriver {
    Class<? extends LEDRiverImpl> IMPL = LEDRiverImpl.class;

    LEDRiverDriver setHide(boolean hidden);
    LEDRiverDriver setMode(Mode mode);
    LEDRiverDriver setLEDMode(LEDMode ledMode);
    LEDRiverDriver setColorDepth(ColorDepth colorDepth);
    LEDRiverDriver setLEDCount(int numLEDs);
    LEDRiverDriver setColor(Color color);
    LEDRiverDriver setColor(int androidColor);
    LEDRiverDriver setColor(int index, Color color);
    LEDRiverDriver setColor(int index, int androidColor);
    LEDRiverDriver setPattern(Pattern pattern);
    LEDRiverDriver setBrightness(double dimmer);
    void apply();
    ...
    class LEDRiverImpl extends I2cDeviceSynchDevice<I2cDeviceSynch> implements LEDRiverDriver {
        ...
        @Override
        public LEDRiverDriver setHide(boolean hidden) {
            this.hidden = hidden;
            return this;
        }

        @Override
        public LEDRiverDriver setMode(Mode mode) {
            this.mode = mode;
            return this;
        }

        @Override
        public LEDRiverDriver setLEDMode(LEDMode ledMode) {
            this.ledMode = ledMode;
            return this;
        }

        @Override
        public LEDRiverDriver setColorDepth(ColorDepth colorDepth) {
            this.colorDepth = colorDepth;
            return this;
        }

        @Override
        public LEDRiverDriver setLEDCount(int numLEDs) {
            this.ledCount = numLEDs;
            return this;
        }

        @Override
        public LEDRiverDriver setColor(Color color) {
            setColor(0, color);
            return this;
        }

        @Override
        public LEDRiverDriver setColor(int androidColor) {
            setColor(0, androidColor);
            return this;
        }

        @Override
        public LEDRiverDriver setColor(int index, Color color) {
            colorMatrix[index] = color;
            return this;
        }

        @Override
        public LEDRiverDriver setColor(int index, int androidColor) {
            setColor(index, new Color(androidColor));
            return this;
        }

        @Override
        public LEDRiverDriver setPattern(Pattern pattern) {
            this.pattern = pattern;
            return this;
        }

        @Override
        public LEDRiverDriver setBrightness(double dimmer) {
