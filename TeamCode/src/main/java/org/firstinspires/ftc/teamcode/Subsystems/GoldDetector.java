...
public class GoldDetector extends DogeCVDetector implements Constants {

    public AutonomousOpMode auto;
    public Hardware hardware;
    public MaelstromRobot bot;
     ...
     * Simple constructor
     */
    public GoldDetector(AutonomousOpMode auto, Hardware hardware) {
        super();
        detectorName = "Gold Finder"; // Set the detector name
        this.auto = auto;
    ...
    public GoldDetector(Hardware hardware){
        super();
        detectorName = "Gold Finder"; //Set the detector name
        this.hardware = hardware;
        telemetry = hardware.telemetry;
    ...
    public GoldDetector(MaelstromRobot robot){
        super();
        detectorName = "Gold Finder"; //Set the detector name
        this.bot = robot;
        feed = robot.feed;
    ...
    public Mat process(Mat input) {
        ...
        if(bestRect != null){
            ...
            aligned = xPos < alignXMax && xPos > alignXMax;
    ...
    public GoldPosition getGold(double position){
        ...
        else if(!isFound()) return GoldPosition.LEFT;
